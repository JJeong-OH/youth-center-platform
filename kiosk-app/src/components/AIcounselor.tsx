...
export const AICounselor: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
  ...
  return (
    ...
    <div className="flex flex-col h-full" style={{ paddingBottom: '200px' }}>
      ...
      <div style={{
        ...
        <div className="flex items-center bg-white/80 backdrop-blur-lg rounded-xl p-2 border border-white/30 focus-within:ring-2 focus-within:ring-indigo-500 shadow-lg">
          <input
            type="text"
            value={input}
