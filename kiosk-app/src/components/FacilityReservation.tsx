...
const NewReservationView: React.FC<{ 
  ...
  onRefreshBookings: () => void 
    ...
    return (
        <>
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-lg border border-white/30 p-4 mb-6">
            ...
            {errorMessage && (
              <div className="bg-red-100 border border-red-300 text-red-800 px-4 py-3 rounded-xl mb-4 flex items-center gap-3 animate-pulse">
